...
let s:red300 = "#E57373"
let s:red900 = "#B71C1C"
let s:orange300 = "#FFB74D"
let s:yellow300 = "#FFD54F"
let s:lime300 = "#DCE775"
let s:teal200 = "#80CBC4"
let s:blue200 = "#90CAF9"
let s:purple900 = "#4A148C"
let s:deeppurple200 = "#B39DDB"
let s:indigo900 = "#1A237E"
let s:cyan900 = "#006064"

let s:unknown = "#ff0000"

let s:palette.red        = { 'dark': s:red300, 'light': s:red300 }
let s:palette.orange     = { 'dark': s:orange300, 'light': s:orange300 }
let s:palette.yellow     = { 'dark': s:yellow300, 'light': s:yellow300 }
let s:palette.green      = { 'dark': s:lime300, 'light': s:lime300 }
let s:palette.aqua       = { 'dark': s:teal200, 'light': s:teal200 }
let s:palette.blue       = { 'dark': s:blue200, 'light': s:blue200 }
let s:palette.purple     = { 'dark': s:deeppurple200, 'light': s:deeppurple200 }
let s:palette.darkblue   = { 'dark': s:indigo900, 'light': s:indigo900 }
let s:palette.darkcyan   = { 'dark': s:cyan900, 'light': s:cyan900 }
let s:palette.darkred    = { 'dark': s:red900, 'light': s:red900 }
let s:palette.darkpurple = { 'dark': s:purple900, 'light': s:purple900 }

let s:palette.background = { 'dark': s:gray900, 'light': s:gray50 } " Background
let s:palette.foreground = { 'dark': s:gray50, 'light': s:gray900 } " Foreground, Font
...
let s:palette.window     = { 'dark': s:gray600, 'light': s:gray600 }
let s:palette.darkcolumn = { 'dark': s:unknown, 'light': s:unknown }
let s:palette.addbg      = { 'dark': s:unknown, 'light': s:unknown }
let s:palette.addfg      = { 'dark': s:unknown, 'light': s:unknown }
let s:palette.changebg   = { 'dark': s:gray600, 'light': s:gray600 }
let s:palette.changefg   = { 'dark': s:gray50, 'light': s:gray50 }
let s:palette.delbg      = { 'dark': s:unknown, 'light': s:unknown }
